...
# Parametrize tests so everything runs even if one fails
...
# Expected fail won't count as a failure for the purposes of 'did the build complete or not?'
@pytest.mark.xfail
...
# Since db_conn is a fixture in tests/conftest.py, having it here as an arg will call the function and yielf the resulting connection to be used
@pytest.mark.xfail
